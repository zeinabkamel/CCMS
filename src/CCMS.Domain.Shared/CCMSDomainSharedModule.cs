...
public class CCMSDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        CCMSGlobalFeatureConfigurator.Configure();
        CCMSModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<CCMSDomainSharedModule>();
        });
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/Localization/CCMS");

            options.DefaultResourceType = typeof(CCMSResource);
        ...
        {
            options.MapCodeNamespace("CCMS", typeof(CCMSResource));
        });
    }
}
