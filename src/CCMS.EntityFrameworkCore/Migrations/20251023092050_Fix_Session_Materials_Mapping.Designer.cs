...
namespace CCMS.Migrations
{
    ...
    [Migration("20251023092050_Fix_Session_Materials_Mapping")]
    partial class Fix_Session_Materials_Mapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CCMS.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("CCMS.Patients.Patient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CCMS.Sessions.Session", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CCMS.Sessions.SessionMaterial", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CCMS.Staffing.DoctorProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CCMS.Staffing.Staff", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DoctorProfileId")
                        .IsUnique()
                        .HasFilter("[DoctorProfileId] IS NOT NULL");

                    b.ToTable("Staff", (string)null);
                });

            modelBuilder.Entity("CCMS.Stores.RawMaterial", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CCMS.Stores.Store", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CCMS.Sessions.SessionMaterial", b =>
                {
                    b.HasOne("CCMS.Sessions.Session", null)
                        .WithMany("Materials")
            ...
            modelBuilder.Entity("CCMS.Staffing.Staff", b =>
                {
                    b.HasOne("CCMS.Staffing.DoctorProfile", "DoctorProfile")
                        .WithOne()
                        .HasForeignKey("CCMS.Staffing.Staff", "DoctorProfileId");
            ...
            modelBuilder.Entity("CCMS.Stores.RawMaterial", b =>
                {
                    b.HasOne("CCMS.Stores.Store", "Store")
                        .WithMany()
